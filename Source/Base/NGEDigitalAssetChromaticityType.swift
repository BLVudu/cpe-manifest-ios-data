                ...
                if let _currentElementNameXmlChar = xmlTextReaderConstLocalName(reader) {
                    ...
                    if("ChromaticityCIEx" == _currentElementName) {
                        ...
                        if let elementValue = xmlTextReaderConstValue(reader) {
                            ...
                            self.ChromaticityCIEx = decFormatter.number(from: String(cString: elementValue))!.doubleValue
                        ...
                        if let elementValue = xmlTextReaderConstValue(reader) {
                            ...
                            self.ChromaticityCIEy = decFormatter.number(from: String(cString: elementValue))!.doubleValue
