...
import com.wb.nextgen.md.schema.v2_3.DigitalAssetAudioDataType;


/**
 * <p>Java class for InventoryAudio-type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InventoryAudio-type"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.movielabs.com/schema/md/v2.3/md}DigitalAssetAudioData-type"&gt;
 *       &lt;sequence&gt;
 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="AudioTrackID" use="required" type="{http://www.movielabs.com/schema/manifest/v1.4/manifest}AudioTrackID-type" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "InventoryAudio-type", propOrder = {
    "containerReference"
})
public class InventoryAudioType
    extends DigitalAssetAudioDataType
{

    @XmlElement(name = "ContainerReference")
    protected ContainerReferenceType containerReference;
    @XmlAttribute(name = "AudioTrackID", required = true)
