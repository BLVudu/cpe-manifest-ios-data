...
/**
 * <p>Java class for AncillaryTrackReference-type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AncillaryTrackReference-type"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="AncillaryTrackID" type="{http://www.movielabs.com/schema/manifest/v1.4/manifest}AncillaryTrackID-type" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "AncillaryTrackReference-type", propOrder = {
    "ancillaryTrackID",
    "adaptationSetID",
    "trackProfile"
})
public class AncillaryTrackReferenceType {

    @XmlElement(name = "AncillaryTrackID", required = true)
    @XmlSchemaType(name = "anyURI")
    protected List<String> ancillaryTrackID;
    @XmlElement(name = "AdaptationSetID")
    protected AncillaryTrackReferenceType.AdaptationSetID adaptationSetID;
     ...
     * This is why there is not a <CODE>set</CODE> method for the ancillaryTrackID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAncillaryTrackID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getAncillaryTrackID() {
        if (ancillaryTrackID == null) {
            ancillaryTrackID = new ArrayList<String>();
        }
        return this.ancillaryTrackID;
    }
     ...
     * @return
     *     possible object is
     *     {@link AncillaryTrackReferenceType.AdaptationSetID }
     *     
     */
    public AncillaryTrackReferenceType.AdaptationSetID getAdaptationSetID() {
     ...
     *     
     */
    public void setAdaptationSetID(AncillaryTrackReferenceType.AdaptationSetID value) {
